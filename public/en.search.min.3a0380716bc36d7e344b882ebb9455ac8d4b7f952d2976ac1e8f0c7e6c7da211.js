...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.14dcb2fce89f9cd307c3ff6563ce8ccda3054d0ceb45ae008853fda7ccfb0e9e.js',function(){input.required=false;search();});}
