...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.623c24619c4304904509cc292db97b9da679a4353859f034a8c047ae816cbac0.js',function(){input.required=false;search();});}
